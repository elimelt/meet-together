      ...
      <div id="header" className="flex flex-row justify-left items-center min-w-lg">
        ...
        <Link to="/">
          <p onClick={() => {
            setFormData([])
            setResponseData([])
          }} className="text-lg pl-2 pr-2 pb-1 ml-10 mr-5 border-b-4 border-transparent hover:border-black hover:border-b-2 hover:border-b border-opacity-0 hover:border-opacity-100 transition-transform transform hover:translate-y-px">HOME</p>
        </Link>
        <Link to="/about">
